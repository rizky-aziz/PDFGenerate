...
public class MainActivity extends AppCompatActivity {
    ...
    private void createPdfWrapper() throws FileNotFoundException, DocumentException{
        int  hasWriteStoragePermissions = ActivityCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        ...
        switch (requestCode) {
            case REQUEST_CODE_ASK_PERMISSIONS:
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(this, "WRITE_EXTRENAL Permission Denied", Toast.LENGTH_SHORT).show();
                }
                break;
                default:
